...
//         $html .= "<div class='aya-header'><span class='aya-ref'>{$sura}:{$ayaNum}</span>{$actionBtns}</div>";
		...
		<div class='settings-bar'>
			...
			<button class='play-surah-btn' id='play-surah-btn' onclick='playSurahFromStart()' title='Play Surah'>
				<svg viewBox='0 0 24 24' width='22' height='22'><path d='M8 5v14l11-7z' fill='white'/></svg>
			</button>

			<div class='ayat-audio-player' id='ayat-audio-player'>
				...
				<button class='ayat-ctrl-btn ayat-play-pause' onclick='ayatPlayerToggle()' title='Play/Pause'>
					<svg class='ap-play' viewBox='0 0 24 24' width='20' height='20'><path d='M8 5v14l11-7z'/></svg>
					<svg class='ap-pause' viewBox='0 0 24 24' width='20' height='20' style='display:none;'><path d='M6 19h4V5H6v14zm8-14v14h4V5h-4z'/></svg>
				</button>
				...
				<button class='ayat-ctrl-btn' onclick='toggleVolume()' id='volume-btn' title='Volume'>
					<svg viewBox='0 0 24 24' width='16' height='16'><path d='M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z'/></svg>
				</button>
